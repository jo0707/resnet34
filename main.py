...
def train_model(model):
    print("="*80)
    print("PLAIN-34 TRAINING ON INDONESIAN FOOD DATASET")
    print("="*80)
    ...
    best_model_path = "plain34_best_model.pth"
...
if __name__ == "__main__":
    ...
    model, best_accuracy, history = train_model(plain34model)

    resnet34model = ResNet34()
    model, best_accuracy, history = train_model(resnet34model)
